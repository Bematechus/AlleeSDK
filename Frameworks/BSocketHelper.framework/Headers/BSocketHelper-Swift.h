...
#import <BSocketHelper/BSocketHelper.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BSocketHelper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class GCDAsyncSocket;

SWIFT_CLASS("_TtC13BSocketHelper13BSocketHelper")
@interface BSocketHelper : NSObject <GCDAsyncSocketDelegate>
...
SWIFT_PROTOCOL("_TtP13BSocketHelper21BSocketHelperDelegate_")
@protocol BSocketHelperDelegate
@optional
- (void)socketStarted;
...
SWIFT_CLASS("_TtC13BSocketHelper15BroadcastDevice")
@interface BroadcastDevice : NSObject
...
SWIFT_CLASS("_TtC13BSocketHelper18BroadcastDiscovery")
@interface BroadcastDiscovery : NSObject <GCDAsyncUdpSocketDelegate>
